...
# =============================================================================
# Unified Firewall Script for hek3ster
# Handles initial setup, ongoing updates, and restoration on boot
# =============================================================================

# Configuration (injected via Go text/template)
...
setup_iptables() {
    ...
    # This is safe during initial setup as it runs via cloud-init before SSH is fully operational
    iptables -F INPUT
