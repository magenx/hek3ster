...
type PublicNetwork struct {
	...
	UseLocalFirewall         bool               `yaml:"use_local_firewall,omitempty"`
	HetznerIPsQueryServerURL string             `yaml:"hetzner_ips_query_server_url,omitempty"`
}
